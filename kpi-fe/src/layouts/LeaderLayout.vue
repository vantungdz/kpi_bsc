  ...
  <div class="flex h-screen overflow-hidden">
    ...
    >
      <div class="h-16 flex items-center px-6 border-b border-slate-200">
        <div
          class="bg-gradient-to-br from-emerald-600 to-teal-600 text-white p-2 rounded-lg shadow-md mr-3"
        >
      ...
      <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
        ...
        >
          ...
          <!-- <span
            ...
            class="min-w-[1.25rem] h-5 px-1.5 rounded-full bg-rose-500 text-white text-[10px] font-bold flex items-center justify-center shrink-0"
          >
            {{ item.badge }}
          </span> -->
          <span
