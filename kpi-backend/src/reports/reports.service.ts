...
import { KpiQueryService } from '../kpis/services/kpi-query.service';
...
export class ReportsService {
  constructor(
    private readonly kpisService: KpiQueryService,
  ...
  async generateKpiReport(
    ...
    if (fileFormat === 'pdf') {
      ...
      try {
        ...
        // Log logo loading error but continue with report generation
        console.warn('Could not load logo image for PDF report:', logoError.message);
        // Add fallback text instead of logo
        doc.fontSize(12).text('KPI Management System', 40, 20);
      }
