...
import { UpdateSectionOrderDto } from './dto/update-order.dto';
...
export class SectionsController {
  ...
  @Patch('update-order')
  async updateOrder(
    @Body() updateOrderDto: UpdateSectionOrderDto,
  ): Promise<{ success: boolean; message?: string }> {
    return this.sectionService.updateSortOrder(updateOrderDto.sections);
  }
}
