...
@Index('IDX_kpis_created_by', ['created_by'])
@Index('IDX_kpis_created_at', ['created_at'])
@Index('IDX_kpis_dates', ['start_date', 'end_date'])
export class Kpi {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @ManyToOne(() => StrategicObjective, (so) => so.kpis, {
    nullable: true,
    onDelete: 'SET NULL',
  })
