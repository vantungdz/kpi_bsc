            ...
            >
              <template #bodyCell="{ column, record }">
                ...
                <template v-else-if="column.key === 'status_before'">
                  <a-tag
                    v-if="record.status_before"
                    :color="getValueStatusColor(record.status_before)"
                  >
                ...
                <template v-else-if="column.key === 'status_after'">
                  <a-tag
                    v-if="record.status_after"
                    :color="getValueStatusColor(record.status_after)"
                  >
