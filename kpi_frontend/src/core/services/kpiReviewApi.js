...
export async function submitSectionReview(reviewId, score, comment, isDraft) {
...
export async function submitDepartmentReview(reviewId, score, comment, isDraft) {
...
export async function submitManagerReview(reviewId, score, comment, isDraft) {
...
export async function batchApproveReviews(employeeIds, level) {
  return apiClient.post(`/kpi-review/batch-approve`, {
    employeeIds,
    level,
  });
}
