...
export const RBAC_PERMISSION_PAIRS = [
  ...
  // Bổ sung action quản trị động
  {
    action: RBAC_ACTIONS.MANAGE_ASSIGNMENT,
  ...
  { action: RBAC_ACTIONS.COPY_TEMPLATE, resource: RBAC_RESOURCES.KPI_COMPANY },
  {
    action: RBAC_ACTIONS.COPY_TEMPLATE,
    resource: RBAC_RESOURCES.KPI_DEPARTMENT,
  },
  { action: RBAC_ACTIONS.COPY_TEMPLATE, resource: RBAC_RESOURCES.KPI_SECTION },
  { action: RBAC_ACTIONS.COPY_TEMPLATE, resource: RBAC_RESOURCES.KPI_EMPLOYEE },
  // KPI Value
