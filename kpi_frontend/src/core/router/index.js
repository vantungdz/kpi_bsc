...
import PersonalTemplatesCreate from "../../features/kpi/views/create/PersonalTemplatesCreate.vue";
import KpiListTemplates from "../../features/kpi/views/list/KpiListTemplates.vue";
import KpiCreateTemplates from "../../features/kpi/views/create/KpiCreateTemplates.vue";
...
import KpiApprovalList from "../../features/kpi/views/KpiApprovalList.vue";
...
import SystemDocsView from "@/features/system-docs/views/SystemDocsView.vue";
import MyTasksPage from "@/features/tasks/views/MyTasksPage.vue";
import NavigationHub from "@/features/navigation/views/NavigationHub.vue";
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "templates",
        name: "KpiListTemplates",
        component: KpiListTemplates,
        meta: {
          requiresAuth: true,
        },
      },
  ...
  {
    path: "/personal/create-templates",
    name: "KpiPersonalTemplatesCreate",
    component: PersonalTemplatesCreate,
    meta: { requiresAuth: true },
  },
  {
    path: "/personal",
  ...
  },
  {
    ...
    name: "SystemKpiSettingsHub",
    component: NavigationHub,
    props: { section: "systemKpi" },
    meta: {
      requiresAuth: true,
      permissions: [
        { action: RBAC_ACTIONS.VIEW, resource: RBAC_RESOURCES.ADMIN },
      ],
    },
  },
  {
    path: "/system/platform",
    name: "SystemPlatformHub",
    component: NavigationHub,
    props: { section: "systemPlatform" },
    meta: {
      requiresAuth: true,
      permissions: [
        { action: RBAC_ACTIONS.VIEW, resource: RBAC_RESOURCES.ADMIN },
  ...
  {
    path: "/kpis/approval",
    name: "KpiApprovalList",
    component: KpiApprovalList,
    meta: {
      requiresAuth: true,
      permissions: [
        {
