<template>
  <div class="kpi-process-statistics-container">
    ...
    <h1 style="font-size: 20px; font-weight: 600"><line-chart-outlined style="margin-right: 8px; color: #1890ff; font-size: 24px" /> {{ $t("kpiProcessStatisticsDetail") }}</h1>
        ...
        <template v-if="!kpiAwaitingStatsError">
          ...
          <a-col :xs="24" :sm="12" :md="8" :lg="6">
            <a-card>
              ...
              >
                <a-statistic
                  :title="$t('totalKpiAwaitingApproval')"
          ...
          <template v-else-if="kpiAwaitingApprovalStats?.byLevel?.length > 0">
            ...
            >
              <a-card>
                <a-statistic
                  :title="$t(`approvalLevels.${level.status}`)"
                  :value="level.count"
                  class="statistic-value"
                />
              </a-card>
    ...
    <a-card
      :title="$t('averageApprovalTime')"
      class="dashboard-card card-avg-time"
    >
      <a-row :gutter="[16, 16]">
        ...
        <template v-if="!averageApprovalTimeError">
          <a-col :xs="24" :sm="12" :md="8">
            <a-card>
              ...
              >
                <a-statistic
                  :title="$t('totalAverageApprovalTime')"
          ...
          >
            <a-card>
              ...
              >
                <a-statistic
                  :title="$t('averageApprovalTimeAt', { level: level.name })"
                  :value="level.averageTime ?? ''"
                  suffix="$t('hours')"
                  class="statistic-value"
                />
              </a-skeleton>
    ...
    <a-card
      :title="$t('topKpiActivity')"
      class="dashboard-card card-top-activity"
    >
      <a-row :gutter="[16, 16]">
